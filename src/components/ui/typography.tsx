...
export function H3(props: Props & ComponentProps<"h3">) {
	return (
		<h3
			className={cn("scroll-m-20 font-semibold text-2xl tracking-tight", props.className)}
			{...props}
		/>
	);
}
...
export function H4(props: Props & ComponentProps<"h4">) {
	return (
		<h4
			className={cn("scroll-m-20 font-semibold text-xl tracking-tight", props.className)}
			{...props}
		/>
	);
}
...
export function TextLarge(props: Props & ComponentProps<"p">) {
	return <p className={cn("font-semibold text-lg", props.className)} {...props} />;
}

export function Muted(props: Props & ComponentProps<"p">) {
	return (
		<p className={cn("text-muted-foreground text-sm", props.className)} {...props} />
	);
}

export function Lead(props: Props & ComponentProps<"p">) {
	return (
		<p className={cn("text-muted-foreground text-xl", props.className)} {...props} />
	);
}
...
export function Strong(props: Props & ComponentProps<"strong">) {
